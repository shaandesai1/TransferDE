...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        # print(batch_t.shape)
        zinit = torch.tensor([[0.5,-10.]]).reshape(-1,2)#torch.ones_like(batch_y0)
        ...
        if itr % args.test_freq == 0:
            with torch.no_grad():
                ...
                zinit = torch.tensor([[0.5,-2-2**3]]).reshape(-1,2)
                pred_y = true_y0.reshape(1,1,2) + gt*odeint(func, zinit, t,method='euler')
